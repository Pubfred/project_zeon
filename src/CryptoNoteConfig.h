...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x69ec0; // address start with "ZEon"
...
const int      P2P_DEFAULT_PORT                              = 21002;
const int      RPC_DEFAULT_PORT                              = 21006;
...
const std::initializer_list<const char*> SEED_NODES = {
     ...
     "178.62.201.169:21002",
     "107.191.111.155:21002",
